...
0. 安装 `Docker` 和 `Docker Compose`，可参考[阿里云官方文档](https://help.aliyun.com/zh/ecs/user-guide/install-and-use-docker#800b337f470oq)

1. 安装并配置 Web Server，这里强烈推荐 `Caddy`，配置简单，支持自动 HTTPS。
